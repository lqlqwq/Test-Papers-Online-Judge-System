...
<head>
    ...
    <style>
        .img{background-image: url(./img/bg/Hiten5.png)}
    </style>
    ...
    <script type="text/javascript" src="./js/pageJS/stu-score/1.js"></script>
    <script type="text/javascript">
        $(function () {
          ...
          <#if loginUser ??>
            ...
            // $('#test').click(function () {
            //     document.getElementById("yournum").innerText=100;
            // })
        })
    </script>
</head>
